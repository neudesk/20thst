...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'comment_comment', (
            ...
            ('submessage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comment.Comment'])),
    ...
    models = {
        ...
        u'comment.comment': {
            ...
            'submessage': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comment.Comment']"}),
