...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'activetoken_token', 'token', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32))
        # Adding unique constraint on 'Token', fields ['token']
        db.create_unique(u'activetoken_token', ['token'])


    def backwards(self, orm):
        # Removing unique constraint on 'Token', fields ['token']
        db.delete_unique(u'activetoken_token', ['token'])


        # Changing field 'Token.token'
        db.alter_column(u'activetoken_token', 'token', self.gf('django.db.models.fields.CharField')(max_length=50))
